export function AboutSection() {
  return (
    <section id="apropos" className="py-12 md:py-20 bg-muted/30">
          ...
          <div>
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              <p className="text-balance">
                ...
                c&apos;est un lieu de confiance, de proximité et de partage. Fondée par deux sœurs,{" "}
                Rosa et Lurdes, Mod&apos;Elle est née d&apos;une passion commune pour la mode féminine 
